...
online version: https://github.com/marckassay/PowerBolt/blob/0.0.4/docs/ConvertTo-EnumFlag.md
schema: 2.0.0
---
...
[ConvertTo-EnumFlag.ps1](https://github.com/marckassay/PowerBolt/blob/0.0.4/src/utility/ConvertTo-EnumFlag.ps1)
